    ...
    <>
      ...
      {/* <div id="projects" className="flex flex-col place-content-center min-h-screen w-100 bg-[#CFDBD5]">*/}
        ...
        <div id="projects" className="bg-[#303030] bg-gradient-to-br from-[#E8EDDF] to-[#90b59b] bg-cover relative min-h-screen w-100 flex flex-col content-evenly overflow-hidden">
            <h1 className="text-center absolute top-48 md:top-52 lg:top-52 left-1/2 -translate-x-1/2 py-4 text-4xl lg:text-8xl md:text-6xl text-[#242423] font-bold select-none">PROJECTS</h1>
            <ProjectCarousel />
            <h1 className="text-center absolute bottom-48 md:bottom-52 lg:bottom-52 left-1/2 -translate-x-1/2 py-4 text-6xl lg:text-8xl md:text-6xl text-[#242423] font-bold select-none">⟷</h1>
