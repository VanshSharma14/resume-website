    ...
    return (
        <div className='place-content-center flex flex-wrap gap-6' >
            ...
            <div className="max-w-sm bg-[#242423] border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                ...
                <div className="p-5">
                    <a href="https://github.com/VanshSharma14/vim-loader">
                        <h5 className="mb-2 text-2xl font-bold tracking-tight text-[#E8EDDF]">Vim Loader</h5>
                    </a>
                    <p className="mb-3 font-normal text-[#E8EDDF]">A quick, open-source, & portable IDE for a lightweight customized Vim8 environment set up almost instantly!</p>
                    <a href="https://github.com/VanshSharma14/vim-loader" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-black bg-[#F5CB5C] rounded-lg hover:bg-[#e6ad0f] focus:ring-4 focus:outline-none focus:ring-[#fae7b2]">
                        Read more
                    </a>
                </div>
            </div>
            ...
            <div className="max-w-sm bg-[#242423] border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                ...
                <div className="p-5">
                    <a href="https://github.com/VanshSharma14/Car-Soccer">
                        <h5 className="mb-2 text-2xl font-bold tracking-tight text-[#E8EDDF]">Car Soccer</h5>
                    </a>
                    <p className="mb-3 font-normal text-[#E8EDDF]">A retro 2D replica of Rocket League featuring a dynamic UI, complex hitbox manipulation and 2 player support!</p>
                    <a href="https://github.com/VanshSharma14/Car-Soccer" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-black bg-[#F5CB5C] rounded-lg hover:bg-[#e6ad0f] focus:ring-4 focus:outline-none focus:ring-[#fae7b2]">
                        Read more
                    </a>
                </div>
            </div>
            ...
            <div className="max-w-sm bg-[#242423] border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                ...
                <div className="p-5">
                    <a href="https://github.com/VanshSharma14/LegBot">
                        <h5 className="mb-2 text-2xl font-bold tracking-tight text-[#E8EDDF]">LegBot</h5>
                    </a>
                    <p className="mb-3 font-normal text-[#E8EDDF]">Discord bot that uses MongoDB, GPT3 and other plugins and commands for a high-utility discord experience.</p>
                    {/* <div className="static bottom-0 left-0"> */}
                    <a href="https://github.com/VanshSharma14/LegBot" className="inline-flex bottom-0 left-0 items-center px-3 py-2 text-sm font-medium text-center text-black bg-[#F5CB5C] rounded-lg hover:bg-[#e6ad0f] focus:ring-4 focus:outline-none focus:ring-[#fae7b2]">
                        Read more
                    </a>
                    {/* </div> */}
                </div>
